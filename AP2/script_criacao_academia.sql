...
-- Table `mydb`.`modalide`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`modalide` (
...
-- Table `mydb`.`tuma`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`tuma` (
  ...
  CONSTRAINT `Modalidade_Turma`
    ...
    REFERENCES `mydb`.`modalide` (`codigo_modalidade`)
    ON DELETE SET NULL
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mydb`.`aluno_turma` (
  ...
  CONSTRAINT `Turma_Aluno`
    ...
    REFERENCES `mydb`.`tuma` (`codigo_turma`)
    ON DELETE NO ACTION
    ON UPDATE CASCADE)
ENGINE = InnoDB;
